--[[
  ...
  Method:   decompile
  Name:     Themes
  Path:     game.ReplicatedStorage.SatchelLoader.Satchel.Packages._Index.1foreverhd_topbarplus@3.3.1.topbarplus.Features.Themes
...
function u1.getInstanceValue(u9, u10) -- Line: 28
...
function u1.getRealInstance(p11) -- Line: 38
...
function u1.getClippedClone(p12) -- Line: 49
...
function u1.refresh(p13, p14, p15) -- Line: 60
    -- upvalues: u1 (copy)
    if p15 then
...
function u1.apply(p25, p26, u27, u28, p29) -- Line: 93
    -- upvalues: u1 (copy)
...
function u1.getModifications(p34) -- Line: 153
    return typeof(p34[1]) ~= "table" and { p34 } or p34;
end;

function u1.merge(p35, p36, p37) -- Line: 162
    -- upvalues: u1 (copy)
...
function u1.modify(u45, u46, u47) -- Line: 175
    ...
    task.spawn(function() -- Line: 183
        ...
        for _, v in pairs(u46) do
            ...
            local function nowSetIt() -- Line: 195
...
function u1.remove(p55, p56) -- Line: 220
    -- upvalues: u1 (copy)
...
function u1.removeWith(p57, p58, p59, p60) -- Line: 233
    -- upvalues: u1 (copy)
...
function u1.change(p62) -- Line: 249
    -- upvalues: u1 (copy)
...
function u1.set(u67, p68) -- Line: 259
    -- upvalues: u1 (copy)
    local themesJanitor = u67.themesJanitor;
    themesJanitor:clean();
    themesJanitor:add(u67.stateChanged:Connect(function() -- Line: 265
...
function u1.statesMatch(p69, p70) -- Line: 275
    local v71;
