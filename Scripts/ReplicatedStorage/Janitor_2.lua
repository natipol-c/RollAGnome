--[[
  ...
  Method:   decompile
  Name:     Janitor
  Path:     game.ReplicatedStorage.SatchelLoader.Satchel.Packages._Index.1foreverhd_topbarplus@3.3.1.topbarplus.Packages.Janitor
...
local function getPromiseReference() -- Line: 26
    return false;
end;
...
function u3.__index.AddPromise(p14, u15) -- Line: 103
    ...
    local v21 = p14:Add(v16.new(function(p18, p19, p20) -- Line: 111
        -- upvalues: u15 (copy)
        if p20(function() -- Line: 112
            -- upvalues: u15 (ref)
            u15:cancel();
        end) then
            return;
...
function u3.__index.AddObject(p22, p23) -- Line: 133
...
function u3.__index.Remove(p27, p28) -- Line: 151
    -- upvalues: u1 (copy)
    local v29 = p27[u1];
...
function u3.__index.Get(p33, p34) -- Line: 180
    -- upvalues: u1 (copy)
    local v35 = p33[u1];
...
function u3.__index.Cleanup(p36) -- Line: 188
    -- upvalues: u1 (copy)
        ...
        for i, v in next, p36 do
            if i ~= u1 then
                ...
                if v37 == "string" or v37 == "number" then
                    ...
                    local function warnUser(p40) -- Line: 205
                        -- upvalues: u39 (copy)
...
function u3.__index.Destroy(p47) -- Line: 244
    p47:Cleanup();
end;
...
function u48.Disconnect(p49) -- Line: 254
...
function u48.__tostring(p50) -- Line: 261
    return "Disconnect<" .. tostring(p50.Connected) .. ">";
end;

function u3.__index.LinkToInstance(u51, p52, p53) -- Line: 265
    ...
    u54 = p52.AncestryChanged:Connect(function(p58, p59) -- Line: 271, Name: ChangedFunction
...
function u3.__index.LinkToInstances(p60, ...) -- Line: 308
    -- upvalues: u3 (copy)
    local v61 = u3.new();
