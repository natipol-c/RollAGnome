--[[
  ...
  Method:   decompile
  Name:     GreenOutline
  Path:     game.ReplicatedStorage.Library.Imported.EasyVisuals.Presets.GreenOutline
...
return function(p1, u2, p3) -- Line: 5
    ...
    local u5 = Parent.Gradient.new(u4.Instance, Parent.Templates.Green.Color, Parent.Templates.Green.Transparency);
    local u6 = 5;
    local u7 = nil;
